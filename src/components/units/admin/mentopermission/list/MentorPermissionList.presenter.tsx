...
export default function MentorPermissionListUI(props) {
  const testCode = [
    {
      division: '멘토신청',
      name: '이름 이름 이름',
    ...
    },
    {
      ...
      name: '이름 이름 이름',
      category:
        'Java, C++, Python, React Java, C++, Python, React Java, C++, Python, React Java, C++, Python, React',
      createAt: '2022-03-21',
    },
    {
      division: '멘토신청',
  ...
  return (
    <CH.Wrapper>
      <CH.MentorPermission__Header>
        <span className="NoteTitle">멘토 신청 리스트</span>
      </CH.MentorPermission__Header>
      <CH.MentorPermission__Body>
        ...
        <CH.Body__Body>
          {testCode.map((el, index) => (
            <CH.ListWrapper
              key={uuidv4()}
              onClick={props.onClickMentorPermissionDetail}
            >
              <div>{index + 1}</div>
