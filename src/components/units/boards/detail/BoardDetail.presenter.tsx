...
import BoardLikeButton from '../../../../commons/libraries/qtlikebutton'
    ...
    <CH.Wrapper>
      <CH.ContentWrapper>
        <div className="contentHeader">
          <div>
            <div>{props.boardData?.fetchQtBoard.title}</div>
            <span>{getMyDate2(props.boardData?.fetchQtBoard.createdAt)}</span>
          </div>
          <div className="LikeButtonWrapper">
            <BoardLikeButton
              onClick={props.onClickLikeBoard}
              count={props.boardData?.fetchQtBoard.likescount}
            />
            <span className="boardLikeCount">
              {props.boardData?.fetchQtBoard.likescount}
            </span>
          </div>
        </div>
        <div className="contentBody">
          <ToastViewerPage contents={props.boardData?.fetchQtBoard.contents} />
        </div>
        ...
        <div className="writerDetail">{props.boardData?.fetchQtBoard.name}</div>
        <BoardComments
